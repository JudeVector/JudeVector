...
<h3> A Software Developer 👨‍💻, Open Source contributor ⛓️, Technical with knowledge in Python and JavaScript with frameworks like NextJS, NodeJs, FastAPI, Django, also a Web3 and AI enthusiast </h3>
